    ...
    <div className="home-page">
      ...
      {/* Banner */}
          ...
          <img
            ...
            <div className="contact-button">
                <Link to="/contact">
                    <button className="contact-button-inner">Contact</button>
                </Link>
            </div>
      ...
      <div className="about-us-container">
          <section className="about-us-section">
            ...
            You can also easily customize your order to your preferences and get real-time updates on menu availability and prices. Plus, you can earn rewards for your dining experiences.
      ...
      <section className="benefits-section">
          ...
          <div className="benefits-text-container">
            ...
            <p className="benefits-text">
              ...
              Real-Time Menu Updates: Easily showcase daily specials, new dishes, and promotions with instant digital menu updates.
              Informed Decision-Making: Access valuable data on customer preferences and ordering habits to refine offerings and strategies.
     ...
     {/* Footer */}
      ...
      <div className="footer-content">
        <div className="footer-top">
          ...
          <div>Built with <span className="heart-emoji">❤️</span></div>
        </div>
